...
export enum ErdDishwasherCycleState {
  NONE            = '0x00',
  PRE_WASH        = '0x01',
  SENSING         = '0x02',
  MAIN_WASH       = '0x03',
...
export enum ErdLaundryCycleState {
  NONE                    = '0x00',
  PRE_WASH                = '0x01',
  SENSING                 = '0x02',
  FILL                    = '0x03',
